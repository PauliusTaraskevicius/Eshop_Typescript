...
const Product: React.FC<ProductItemProps> = ({ data = {}, userId }) => {
  ...
  return (
    ...
    //         <span classNameName="text-neutral-500 text-sm">{data.createdAt}</span>
    //       </div>
    //       <div classNameName="flex flex-row items-center mt-3 gap-10">
    //         <Image
    //           width={250}
    //           height={250}
    //           alt="thumbnail"
          ...
          <div className="border-t border-b py-4 mt-7 border-gray-200">
            ...
            >
              <p
                ...
                className="text-base leading-4 text-gray-800 dark:text-gray-300"
              >
            ...
            <div
              className={
                shippingOpen
                  ? "pt-4 text-base leading-normal pr-12 mt-4 text-gray-600 dark:text-gray-300"
                  : "hidden pt-4 text-base leading-normal pr-12 mt-4 text-gray-600 dark:text-gray-300"
              }
              id="sect"
            >
